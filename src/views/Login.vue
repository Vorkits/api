                                            ...
                                            <v-row>
                                                ...
                                                <v-col cols="12" md="12">
                                                    <v-text-field v-model="password" hide-details single-line outlined
                                                        ...
                                                        :rules="passwordRules" autocomplete="off" required>
                                                    </v-text-field>
                                                </v-col>
                                            </v-row>
                                            <v-btn @click="submit" block class="red darken-1 mt-6" dark>Enter
                                            </v-btn>
                                ...
                                <v-col >
                                    <v-card flat class="pa-7" tile style="height: 100%;">
                                        ...
                                        <v-form v-model="valid" ref="form">
                                            <v-row>
                                                <v-col cols="12">
                                                    <v-text-field hide-details single-line outlined autocomplete="off"
                                                ...
                                                <v-col cols="12" md="12">
                                                    <v-checkbox hide-details label="Stay updated" class="mt-0">
                                                    </v-checkbox>
                                                </v-col>
                                                <v-col cols="12" md="12">
                                                    <v-checkbox hide-details
                                                        label="I read and acceoted the terms of use" class="mt-0">
                                                    </v-checkbox>
                                                </v-col>

                                            </v-row>

                                            <v-btn @click="submit" block class="red darken-1 mt-6" dark>Sign up for free
                                            </v-btn>
