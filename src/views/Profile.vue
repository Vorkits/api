   ...
   <div class = "main">
        ...
        <div class="player">
            <div class="profile">
                ...
                <div class="photo"><img src='../assets/default.jpg'></div>
        ...
        <div class="info">
            <div class="tennis-players ten"><div class="block">tennis players</div></div>
            <div class="tennis-players-chat ten"><div class="block">tennis players chat</div></div>
            <div class="scheduled-matches ten"><div class="block">scheduled matches</div></div>
        </div>
   </div>
</template>
